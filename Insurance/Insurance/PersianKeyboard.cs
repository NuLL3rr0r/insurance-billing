...
namespace Insurance
{
    ...
    {
        /// <summary>
        ///   CrossPlatformKeyboard Class Build Feb 07, 2K8
        ///   For Cross-Platform Persian Keyboard Article
        ///   © M.S. Babaei
        ...
        public bool usePersianNums = true;
        ...
        public void TransformInputChar(ComboBox textBox, KeyPressEventArgs e)
        {
            if (textBox.MaxLength < textBox.Text.Length)
                return;
