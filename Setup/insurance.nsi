...
; A multilingual message
  ...
  LangString MessageSuccess ${LANG_FARSI} "$(^Name) ÈÇ ãæÝÞíÊ ÇÒ ÓíÓÊã ÔãÇ Uninstall ÔÏ."
  ...
  LangString MessageConfirm ${LANG_FARSI} "ÂíÇ ãÇíá Èå Uninstall ßÇãá $(^Name) æ ÊãÇãí ãæáÝå åÇí Âä åÓÊíÏ(ãØãÆäíÏ)¿"
